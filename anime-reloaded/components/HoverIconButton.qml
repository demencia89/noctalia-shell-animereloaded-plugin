...
Item {
    ...
    Rectangle {
        ...
        radius: width / 2
        color: (root.selected || root.hovered) ? Color.mPrimaryContainer : "transparent"
    ...
    Text {
        ...
        color: (root.selected || root.hovered) ? Color.mOnPrimaryContainer : Color.mOnSurfaceVariant
